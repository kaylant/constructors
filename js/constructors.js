...
var Student = function(inputExpertise) {
    ...
    this.knowledge = 0
    this.learn = function(inputGain) {
        this.knowledge += inputGain
    }
}
...
var KeepSecret = function(secret) {
    ...
    this.squeal = function(inputGain) {
...
var specialKey = new Key()

var Safe = function (pieceOfData, specialKey) {
	var privateSecret = pieceOfData
    var privateKey = specialKey
    this.unlock = function(someKey) {
        if (someKey === privateKey) {
        	return privateSecret
        }
    }
}
...
var Validator = function() {
	this.email = function(someEmail) {
		if (someEmail.indexOf('@') !== -1) {
        	return true
        }
        else false
    }
